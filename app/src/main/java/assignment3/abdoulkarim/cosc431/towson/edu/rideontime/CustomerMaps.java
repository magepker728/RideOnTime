...
public class CustomerMaps extends FragmentActivity implements OnMapReadyCallback,
    ...
    Button customer_settingbtn;
    Button customer_signoutbtn;
    Button customer_callmyridebtn;
    ...
    void var_Init() {
        customer_settingbtn = (Button) findViewById(R.id.customer_settingbtn);
        customer_signoutbtn = (Button) findViewById(R.id.customer_signoutbtn);
        customer_callmyridebtn=(Button)findViewById(R.id.customer_callmyridebtn);
        customer_signoutbtn.setOnClickListener(this);
        customer_settingbtn.setOnClickListener(this);
        customer_callmyridebtn.setOnClickListener(this);
    }
